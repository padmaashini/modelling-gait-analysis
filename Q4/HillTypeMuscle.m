classdef HillTypeMuscle
    ...
    %-don't need to change this, assume muscle has 3 features then can make
    %different instances of this muscle (for different muscles (soleus, TA,
    %etc) and provide vals for specific muscles. To call fct do
    %soleus.fctname(params) 

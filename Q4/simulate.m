...
rest_length_soleus = soleus_length(pi/2); %-angle when person standing upwards / anatomical posn 
...
%- x is is state vector, inside fct need to implement 4eqns from 8A slide
%19. complete fct in dynamics.m, arm lengths fiven in lectures and code, no
%external force. Gravity momnet calcualtes at each angle theta, should call
%this fct. 

...
force_length_regression = get_muscle_force_length_regression(); %-we write
force_velocity_regression = get_muscle_force_velocity_regression(); %-written 

%% Section 2: Question 1:
clc
plot_curves(); %-include these plots as requested in soln file 
